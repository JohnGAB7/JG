...
.. raw:: html
    ...
    <div class="jumbotron">
        <p style="font-size: 1.25rem;">📬 Une question, une idée ou une proposition de collaboration ? N’hésitez pas à me contacter via ce formulaire :</p>
    </div>
    ...
    <form action="https://formspree.io/f/mldekjld" method="POST" class="contact-form" aria-label="Formulaire de Contact">
        ...
        <div id="success-message" class="form-feedback success">✅ Votre message a bien été envoyé !</div>
...
.. raw:: html
    ...
    <div class="likebtn-wrapper" data-theme="custom" data-ef="bounce" data-lang="fr" data-identifier="page_contact_fr"></div>
    <script src="https://w.likebtn.com/js/w/widget.js" async></script>
    <div class="footer-message">
        Merci pour votre visite ! N’hésitez pas à me contacter à tout moment.
    </div>
