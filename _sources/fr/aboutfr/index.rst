...
.. raw:: html
    ...
    <div class="section">Ma chaîne YouTube : Actu-Basics</div>
    <div style="text-align: center; margin-bottom: 3rem;">
        ...
        <p style="margin-top: 1rem; font-size: 1rem; color: #444;">Présentation du projet Actu-Basics&nbsp;: une chaîne pour rendre l'actuariat visuel, accessible et stimulant.</p>
    </div>
